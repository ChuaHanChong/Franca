...
import franca.utils.utils as dinov2_utils
from franca.configs import franca_default_config
from franca.models import vision_transformer as vits
...
def get_cfg_from_args(args):
    default_cfg = OmegaConf.create(franca_default_config)
